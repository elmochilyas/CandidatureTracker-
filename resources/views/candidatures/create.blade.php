                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('candidatures.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="offer_url" class="block mt-1 w-full" type="url" name="offer_url" :value="old('offer_url')" />
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" rows="4">{{ old('notes') }}</textarea>
                            <x-input-error :messages="$errors->get('notes')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="application_date" :value="__('Date de candidature')" />
                            <x-text-input id="application_date" class="block mt-1 w-full" type="date" name="application_date" :value="old('application_date', date('Y-m-d'))" required />
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('candidatures.index') }}" class="text-sm text-gray-600 hover:text-gray-900">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>

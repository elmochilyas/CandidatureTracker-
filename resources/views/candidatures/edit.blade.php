<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-base font-bold text-dark-text">Modifier la candidature</h2>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('candidatures.show', $candidature) }}" class="inline-flex items-center gap-1.5 text-sm text-dark-text-secondary hover:text-dark-text font-medium transition-colors mb-6">
            ...
            <div class="glass-card overflow-hidden">
                ...
                <div class="px-6 sm:px-8 pt-6 pb-5 border-b border-dark-border flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-dark-text">Modifier la candidature</h3>
                        <p class="text-xs text-dark-text-secondary mt-0.5">{{ $candidature->company_name }} &mdash; {{ $candidature->role }}</p>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative mt-1.5">
                                        ...
                                        <x-text-input id="company_name" class="block w-full pl-10 pr-3" type="text" name="company_name" :value="old('company_name', $candidature->company_name)" required autofocus />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1.5">
                                        ...
                                        <x-text-input id="role" class="block w-full pl-10 pr-3" type="text" name="role" :value="old('role', $candidature->role)" required />
                                    </div>
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="relative mt-1.5">
                                        ...
                                        <x-text-input id="offer_url" class="block w-full pl-10 pr-3" type="url" name="offer_url" :value="old('offer_url', $candidature->offer_url)" />
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative mt-1.5">
                                        ...
                                        <x-text-input id="application_date" class="block w-full pl-10 pr-3" type="date" name="application_date" :value="old('application_date', $candidature->application_date->format('Y-m-d'))" required />
                                    </div>
                                ...
                                <div>
                                    ...
                                    @if ($candidature->file_path)
                                        <div class="mt-1.5 mb-2 flex items-center gap-2 text-sm text-dark-text-secondary bg-overlay-subtle rounded-lg px-3 py-2.5 border border-dark-border">
                                            <svg class="w-4 h-4 text-dark-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941l-7.81 7.81a1.5 1.5 0 002.112 2.13"/>
                                            </svg>
                                            <span class="flex-1 truncate text-xs">{{ basename($candidature->file_path) }}</span>
                                            <a href="{{ route('candidatures.download', $candidature) }}" class="text-dark-primary hover:text-dark-primary-hover font-medium text-xs shrink-0">Télécharger</a>
                                        </div>
                                    @endif
                                    <div class="mt-1.5 border-2 border-dashed border-dark-border rounded-glass-input px-4 py-5 text-center hover:border-dark-primary/40 transition-colors duration-200">
                                        ...
                                        <p class="mt-2 text-xs text-dark-text-secondary/60">PDF, DOC, PNG ou JPG &mdash; laissez vide pour conserver le fichier actuel</p>
                                    </div>

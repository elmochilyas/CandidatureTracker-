                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <input id="edit_attachments" type="file" name="attachments[]" multiple accept=".pdf,.doc,.docx,.png,.jpg,.jpeg"
                                            ...
                                            <p class="mt-2 text-xs text-dark-text-secondary/60">PDF, DOC, PNG ou JPG &mdash; ajouter d'autres fichiers</p>
                                        </div>

<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <h2 class="text-2xl font-bold text-dark-text">Réinitialiser le mot de passe</h2>
        <p class="mt-2 text-sm text-dark-text-secondary">Choisissez un nouveau mot de passe sécurisé.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative mt-1.5">
                ...
                <x-text-input id="email" class="block w-full pl-10 pr-3" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
            </div>
